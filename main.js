...
function atualizarSelect() {
    ...
    switch (personagemSelecionado.value) {
        ...
        case 'Nobara-Kugisaki':
            ...
            description.innerHTML = "Nobara é uma jovem confiante e impetuosa com um caráter inabalável. Mais do que tudo, Nobara está determinada a permanecer fiel a si mesma, aconteça o que acontecer. Ela tem muito orgulho de ser uma garota bonita e uma lutadora forte, recusando-se a deixar qualquer um influenciá-la."
        ...
        case "Toge-Inumaki":
            ...
            description.innerHTML = "A impressão inicial de Toge leva as pessoas a acreditarem que ele é uma pessoa quieta, indiferente e distante.No entanto, Toge é na verdade um indivíduo altamente perspicaz e atencioso. Ele é inteligente e entende os perigos de poderes esmagadores."
        ...
        case "Kokichi-Muta":
            ...
            description.innerHTML = "Kokichi era um indivíduo recluso e reservado que se ressentia de ter nascido sem um futuro fora do mundo do jujutsu. Ele orgulhosamente admitiu que devolveria cada grama de energia amaldiçoada para ganhar um corpo normal."
        ...
        case "Noritoshi-Kamo":
            ...
            description.innerHTML = "Noritoshi normalmente é muito calmo e estóico na maioria das situações, seja na frente de seus aliados ou rivais. Excluindo Aoi, ele é um veterano e um líder para seus colegas na escola de Kyoto, exceto Aoi. Ele também sente uma afinidade com aqueles que vêm de famílias de feiticeiros como Megumi . Sua lealdade às famílias de feiticeiros distorceu seus sentimentos quando se trata dos outros."
        ...
        default:
            ...
            description.innerHTML = "Aqui você descobrirá a origem, habilidades, pontos fracos, gostos, crushs... tudo sobre seu personagem favorito."
            break;
    }
